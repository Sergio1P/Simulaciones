...
import com.curso_simulaciones.CR.CR;
import com.curso_simulaciones.objetos_laboratorio.Polea;
...
public class ActividadPrincipalMiOctavaApp extends Activity implements Runnable {
    private static final com.curso_simulaciones.CR.CR CR = ;
...
//pegar linearArriba al princial
        LinearLayout.LayoutParams parametrosPegadoArriba = new
...
//pegar linearAbajo al princial
        LinearLayout.LayoutParams parametrosPegadoAbajo = new
                LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 0);
